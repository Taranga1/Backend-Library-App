...
<div class="form-row">
  <div class="input-data">
    <input type="text" required name="edition" id="edition">
    <div class="underline">
</div>
...
<div class="input-data">
            <input type="text" required name="publication" id="publication">
            <div class="underline">
</div>
...
<div class="form-row">
  <div class="input-data">
    <input type="text" required name="cost" id="cost">
    <div class="underline">
</div>
<label for="cost">Cost</label>
  ...
  <div class="input-data">
    <input type="text" required name="page" id="page">
    <div class="underline">
</div>
...
<div class="form-row">
  <div class="input-data">
    <input type="text" required name="catagory" id="catagory">
    <div class="underline">
</div>
